...
class ResNet(object):
  ...
  def __init__(self, resnet_size=121, bottleneck=True, num_classes=1, num_filters=64,
               kernel_size=7,
               conv_stride=2, first_pool_size=3, first_pool_stride=2,
               block_sizes=[], block_strides=[2,2,2,2],
    ...
    elif self.resnet_size == 34:
        self.bottleneck = False
        self.block_sizes = [3,4,6,3]
    elif self.resnet_size == 50:
        self.bottleneck = True
        self.block_sizes = [3,4,6,3]
    elif self.resnet_size == 101:
        self.bottleneck = True
        self.block_sizes = [3,4,23,3]
    elif self.resnet_size == 152:
        self.bottleneck = True
        self.block_sizes = [3,8,36,3]
    else:
